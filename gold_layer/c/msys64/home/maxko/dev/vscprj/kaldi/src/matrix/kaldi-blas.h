...
//    #include "clapack.h"
    ...
    extern "C" {
      ...
      #include <cblas.h>
	#if defined(HAVE_CLAPACK) && !defined(_WIN32)
...
//  #include "lapacke.h"
  ...
  #undef bit_set
#else
	#if !defined(HAVE_CLAPACK) && !defined(HAVE_ATLAS) && !defined(HAVE_MKL) && !defined(HAVE_OPENBLAS)
		#error "You need BLAS/LAPACK backend"
	#endif
#endif
